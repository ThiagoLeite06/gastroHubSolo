INSERT INTO users (name, email, password, address) VALUES
    ('João Silva', 'joao@email.com', '$2a$10$YourHashedPasswordHere', 'Rua das Flores, 123, São Paulo - SP'),
    ('Maria Santos', 'maria@email.com', '$2a$10$YourHashedPasswordHere', 'Av. Principal, 456, Rio de Janeiro - RJ'),
    ('Pedro Oliveira', 'pedro@email.com', '$2a$10$YourHashedPasswordHere', 'Rua do Comércio, 789, Belo Horizonte - MG');
